...
function renderReport() {
  ...
  app.innerHTML = `
    ...
    <div class="ctrl">
      ...
      <a href="/admin.html" style="padding:8px 14px; background:var(--navy); color:#fff; border-radius:7px; font-size:12px; font-weight:700; text-decoration:none; white-space:nowrap;">⚙️ 관리자</a>
    </div>
